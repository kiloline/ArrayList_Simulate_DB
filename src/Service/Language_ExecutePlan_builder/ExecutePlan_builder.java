...
import Service.Language_ExecutePlan_builder.ExecutePlan_Engine.*;
...
public class ExecutePlan_builder 
{
    ...
    private String default_tbs= Service.env_properties.getEnvironment("default_tbs");
    ...
    private void select() throws ClassNotFound, Language_error {
        Map<TablespaceTable_name,List<KVEntryImpl>> select_result;
        Map<String,Table> from_result;
